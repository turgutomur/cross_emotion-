...
% table* (spans both columns): the "Comparison" column holds long
% method-pair strings that overflow a single \columnwidth, which made
% the p-value column collide with the adjacent figure. Full text width
% removes the overflow and matches Tables 1-2, which are also table*.
\begin{table*}[t]
\centering
\small
\begin{tabular}{llc}
